...
SECRET_KEY = 'django-insecure-%_o0$ph#(gcg_#kh8n9$c*h&64om-^eu350jtcen5*w+3f(=s8'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'BibliotecaAPI_db', #Nombre de la base de datos
        'USER': 'postgres',
        'PASSWORD': '123456789', #Contraseña de POSTGRES
        'HOST': 'localhost',
        'PORT': '5432',
    }
}
